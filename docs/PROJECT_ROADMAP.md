...
| --- | --- | --- | --- |
| 0 Mandate and baseline | This roadmap, service inventory, strategy authority register, milestone tracking | Every component has an owner, purpose and activation boundary | Baseline recorded; account/instrument capability audit pending |
| 1 Portable operations | Mac paper operation, WSL2 deployment templates, secrets abstraction, preflight, private access runbook | Demonstrated PC boot/recovery, backups/restore, old-writer fencing and alerts | Manifest/preflight/templates implemented and reviewed; PC not accessed or verified |
