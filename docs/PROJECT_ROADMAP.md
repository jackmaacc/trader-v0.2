...
| 3 Parallel strategy research | At most two newly frozen hypotheses per asset-class track; causal costs and passive/risk-matched comparisons | Independent review and sufficient untouched prospective evidence | Three design-only protocols and freeze/verify tooling implemented; causal daily/options adapters reviewed; portfolio orchestration, verified data and untouched prospective evidence pending; existing failures retained |
