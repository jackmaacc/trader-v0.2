...
| 2 Durable evidence/accounting | SQLite operational trial ledger, immutable research data, source provenance and broker reconciliation | Reconstruct decisions and cash/quantity changes; resolve discrepancies | Operational ledger plus offline cash/quantity importer implemented; 406 actual fills imported idempotently; exact boundary evidence and full trade accounting remain pending |
| 3 Parallel strategy research | At most two newly frozen hypotheses per asset-class track; causal costs and passive/risk-matched comparisons | Independent review and sufficient untouched prospective evidence | Three design-only protocols and freeze/verify tooling implemented; adapters and untouched prospective evidence pending; existing failures retained |
